...
Source0  : https://files.pythonhosted.org/packages/50/38/47e84d84b5b2a7b37a46f49e50c5a24bbdb23ccbca0bcca07702f804692d/ansible-compat-4.1.5.tar.gz
...
%prep
%setup -q -n ansible-compat-4.1.5
cd %{_builddir}/ansible-compat-4.1.5
pushd ..
cp -a ansible-compat-4.1.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1692043737

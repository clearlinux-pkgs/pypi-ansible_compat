...
Source0  : https://files.pythonhosted.org/packages/59/f9/c48f3a140e3afad144a720f5c29aa8b34087926b2e2fc8778d4d4b5b6323/ansible_compat-24.10.0.tar.gz
...
%prep
%setup -q -n ansible_compat-24.10.0
cd %{_builddir}/ansible_compat-24.10.0
pushd ..
cp -a ansible_compat-24.10.0 buildavx2
popd
pushd ..
cp -a ansible_compat-24.10.0 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1731509137

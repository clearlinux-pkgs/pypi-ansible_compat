...
Version  : 2.2.3
Release  : 24
URL      : https://files.pythonhosted.org/packages/45/c8/7533461dd7de1294a9ea408767885acc6d87d0826e1ef2130a17bf352d03/ansible-compat-2.2.3.tar.gz
Source0  : https://files.pythonhosted.org/packages/45/c8/7533461dd7de1294a9ea408767885acc6d87d0826e1ef2130a17bf352d03/ansible-compat-2.2.3.tar.gz
...
%prep
%setup -q -n ansible-compat-2.2.3
cd %{_builddir}/ansible-compat-2.2.3
pushd ..
cp -a ansible-compat-2.2.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667226377

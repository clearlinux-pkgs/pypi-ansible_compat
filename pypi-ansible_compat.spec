...
Source0  : https://files.pythonhosted.org/packages/30/66/5ab513ccbc8a5820056ee06eab293591a3ed0908eff47e7d3447a4280e20/ansible_compat-25.5.0.tar.gz
...
%prep
%setup -q -n ansible_compat-25.5.0
cd %{_builddir}/ansible_compat-25.5.0
pushd ..
cp -a ansible_compat-25.5.0 buildavx2
popd
pushd ..
cp -a ansible_compat-25.5.0 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747145427

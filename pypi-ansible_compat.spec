...
Source0  : https://files.pythonhosted.org/packages/a8/7b/b884b18774a0149bedb7961428442e29d455195212cd455c0ab0f4ce34f7/ansible-compat-2.2.4.tar.gz
...
%prep
%setup -q -n ansible-compat-2.2.4
cd %{_builddir}/ansible-compat-2.2.4
pushd ..
cp -a ansible-compat-2.2.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667330298

...
Source0  : https://files.pythonhosted.org/packages/fc/36/45725453dc9d44cb31ddd7cf6c71761fb806821541e7553a10927225bdf0/ansible_compat-24.5.1.tar.gz
...
%prep
%setup -q -n ansible_compat-24.5.1
cd %{_builddir}/ansible_compat-24.5.1
pushd ..
cp -a ansible_compat-24.5.1 buildavx2
popd
pushd ..
cp -a ansible_compat-24.5.1 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1715698992

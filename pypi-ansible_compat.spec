...
Source0  : https://files.pythonhosted.org/packages/86/c8/55524ca4f3ef005a02772f99ce40f3963dd2aca8740550acb4b7a6e52d3f/ansible-compat-2.0.2.tar.gz
...
%prep
%setup -q -n ansible-compat-2.0.2
cd %{_builddir}/ansible-compat-2.0.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1649709525
...
cp %{_builddir}/ansible-compat-2.0.2/LICENSE %{buildroot}/usr/share/package-licenses/pypi-ansible_compat/6d176c0e7c1be160c6ae0a7d0aa5f51a4142177e

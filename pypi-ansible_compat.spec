...
Source0  : https://files.pythonhosted.org/packages/81/88/ae87126cee0295bd2906d8e74a157478447e46641d24ee9083fb881c4d66/ansible_compat-24.6.1.tar.gz
...
%prep
%setup -q -n ansible_compat-24.6.1
cd %{_builddir}/ansible_compat-24.6.1
pushd ..
cp -a ansible_compat-24.6.1 buildavx2
popd
pushd ..
cp -a ansible_compat-24.6.1 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1717694859

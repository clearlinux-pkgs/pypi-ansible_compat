...
Version  : 25.0.0
Release  : 52
URL      : https://files.pythonhosted.org/packages/10/a9/2f8915346d533ba6c95b637a4dc94924b597c48db2fb1d1529c9e2b18bc8/ansible_compat-25.0.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/10/a9/2f8915346d533ba6c95b637a4dc94924b597c48db2fb1d1529c9e2b18bc8/ansible_compat-25.0.0.tar.gz
...
%prep
%setup -q -n ansible_compat-25.0.0
cd %{_builddir}/ansible_compat-25.0.0
pushd ..
cp -a ansible_compat-25.0.0 buildavx2
popd
pushd ..
cp -a ansible_compat-25.0.0 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736883981

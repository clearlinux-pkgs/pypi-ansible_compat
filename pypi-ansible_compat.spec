...
Source0  : https://files.pythonhosted.org/packages/e4/44/2ef17ed44841f6144ab7802d52227d7096b98ab24dcdda90491ab90182c6/ansible_compat-25.6.0.tar.gz
...
%prep
%setup -q -n ansible_compat-25.6.0
cd %{_builddir}/ansible_compat-25.6.0
pushd ..
cp -a ansible_compat-25.6.0 buildavx2
popd
pushd ..
cp -a ansible_compat-25.6.0 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1750253731

...
Source0  : https://files.pythonhosted.org/packages/da/9e/f47e1f0c1b8c65b25b8af290662c413d632b618cf65341324a71c39b9a99/ansible_compat-24.6.0.tar.gz
...
%prep
%setup -q -n ansible_compat-24.6.0
cd %{_builddir}/ansible_compat-24.6.0
pushd ..
cp -a ansible_compat-24.6.0 buildavx2
popd
pushd ..
cp -a ansible_compat-24.6.0 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1717010482

...
%prep
%setup -q -n ansible-compat-2.2.0
cd %{_builddir}/ansible-compat-2.2.0
pushd ..
cp -a ansible-compat-2.2.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657754629
...
cp %{_builddir}/ansible-compat-2.2.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-ansible_compat/6d176c0e7c1be160c6ae0a7d0aa5f51a4142177e

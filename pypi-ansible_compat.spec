...
Source0  : https://files.pythonhosted.org/packages/33/79/f74e03dbb2d97f9370b8b6ddaa38c3e2fa4f842d7c85d68f46ea341f55fb/ansible-compat-2.0.3.tar.gz
...
%prep
%setup -q -n ansible-compat-2.0.3
cd %{_builddir}/ansible-compat-2.0.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1652135806
...
cp %{_builddir}/ansible-compat-2.0.3/LICENSE %{buildroot}/usr/share/package-licenses/pypi-ansible_compat/6d176c0e7c1be160c6ae0a7d0aa5f51a4142177e

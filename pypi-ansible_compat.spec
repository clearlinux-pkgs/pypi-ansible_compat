...
Source0  : https://files.pythonhosted.org/packages/37/1a/604884d3655a80476dff5ad3cc9991decc5fb26d3f5df51d38361c3cedb1/ansible-compat-2.2.5.tar.gz
...
%prep
%setup -q -n ansible-compat-2.2.5
cd %{_builddir}/ansible-compat-2.2.5
pushd ..
cp -a ansible-compat-2.2.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1668787871

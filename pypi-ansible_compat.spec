...
Source0  : https://files.pythonhosted.org/packages/66/79/198116bddfa79a05b02f64d617865e5cf1b982f7f25be993ec6efd95d174/ansible_compat-25.1.5.tar.gz
...
%prep
%setup -q -n ansible_compat-25.1.5
cd %{_builddir}/ansible_compat-25.1.5
pushd ..
cp -a ansible_compat-25.1.5 buildavx2
popd
pushd ..
cp -a ansible_compat-25.1.5 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1743688855

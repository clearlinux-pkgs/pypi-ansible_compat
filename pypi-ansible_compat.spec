...
Version  : 2.0.1
Release  : 6
URL      : https://files.pythonhosted.org/packages/03/68/5fe542227b40960a5884142ab5fe12851ee4d2ee702cc7f8367349a50893/ansible-compat-2.0.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/03/68/5fe542227b40960a5884142ab5fe12851ee4d2ee702cc7f8367349a50893/ansible-compat-2.0.1.tar.gz
...
%prep
%setup -q -n ansible-compat-2.0.1
cd %{_builddir}/ansible-compat-2.0.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1647527581
...
cp %{_builddir}/ansible-compat-2.0.1/LICENSE %{buildroot}/usr/share/package-licenses/pypi-ansible_compat/6d176c0e7c1be160c6ae0a7d0aa5f51a4142177e

...
%prep
%setup -q -n ansible_compat-24.9.1
cd %{_builddir}/ansible_compat-24.9.1
pushd ..
cp -a ansible_compat-24.9.1 buildavx2
popd
pushd ..
cp -a ansible_compat-24.9.1 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726695847

...
Source0  : https://files.pythonhosted.org/packages/e7/20/3cbc78afd3bee6a30b95506819b57e70e4e12c3c69da4de35ce2dd03a216/ansible-compat-2.2.1.tar.gz
...
%prep
%setup -q -n ansible-compat-2.2.1
cd %{_builddir}/ansible-compat-2.2.1
pushd ..
cp -a ansible-compat-2.2.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664205466

...
Source0  : https://files.pythonhosted.org/packages/81/81/6ca881fa0afc1f9975feb96d08e48f048d0e6542ea66cc9f67f79a403607/ansible_compat-24.7.0.tar.gz
...
%prep
%setup -q -n ansible_compat-24.7.0
cd %{_builddir}/ansible_compat-24.7.0
pushd ..
cp -a ansible_compat-24.7.0 buildavx2
popd
pushd ..
cp -a ansible_compat-24.7.0 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720715255

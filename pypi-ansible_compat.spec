...
Source0  : https://files.pythonhosted.org/packages/e6/1b/ec4cab729bea3531ad4368d1b66858f9cbee5edd84a32a9830ef7da1f1d2/ansible-compat-2.2.6.tar.gz
...
%prep
%setup -q -n ansible-compat-2.2.6
cd %{_builddir}/ansible-compat-2.2.6
pushd ..
cp -a ansible-compat-2.2.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1669934200
